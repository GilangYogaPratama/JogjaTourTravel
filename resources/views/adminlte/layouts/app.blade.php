...
<head>
  ...
  <title>{{ $title ?? "Jogja Tour & Travel" }} | Dashboard</title>
...
<div class="wrapper">>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="nav-link" style="color:red">Logout</a>
  ...
  <aside class="main-sidebar elevation-3 shadow-sm" style="background: linear-gradient(to bottom,rgb(10, 87, 165),rgb(20, 51, 85));">
  <!-- Brand Logo -->
    <a href="{{ route('home') }}" class="brand-link text-center">
      <img src="{{ asset('storage/images/JTT.png') }}" alt="JTT Logo" style="width: 100%; max-height: 50px; object-fit: contain;">
    </a>
